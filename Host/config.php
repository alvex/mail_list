...
$conf['app']['weburi'] = 'https://www.hemfresh.com/bokning';
...
$conf['app']['adminEmail'] = 'info@hemfresh.se';

// And as the  email address for emploiment  time schedule
$conf['app']['jobbEmail'] = 'jobb@hemfresh.se';
// And as the contact phone number for users with questions
$conf['app']['phone'] = '08-410 11520';

// The default language code.  This must be included in the language list in langs.php
$conf['app']['defaultLanguage'] = 'sv';
...
$conf['app']['techEmail'] = 'info@hemfresh.se';
...
$conf['app']['smtpHost'] = 'smtp.hemfresh.se';

// SMTP port [25]
// This is only required if emailType is SMTP
$conf['app']['smtpPort'] = 25;

// IMAP email host address []
// This is only required if emailType is IMAP
$conf['app']['imapHost'] = 'imap.hemfresh.se';
...
$conf['app']['logfile'] = '/var/log/bokning.txt';
...
// This default services]
$conf['app']['services'] = "Hemst&auml;dning";

// If we should let resource change reserve times
// Can be 0 (no change times) and 1 (change times)
$conf['app']['changeTimes'] = 1;
...
$conf['db']['dbUser'] = 'hemfresh_schedule';

// Password for above user to access schedule database [password]
$conf['db']['dbPass'] = 'MisVainas0909';

// Name for database [phpscheduleit]
//$conf['db']['dbName'] = 'phpscheduleit';

$conf['db']['dbName'] = 'hemfresh_bokning';

// Prefix to attach to all table names [] // OBS M�STE �NDRAS
$conf['db']['tbl_prefix'] = 'cal_';
...
// Ny delar f�r att s�tta info om sms server
$conf['sm']['Username'] = 'alvaro.ortega@hemfresh.se'; 

$conf['sm']['Password'] = 'alvex'; 
//$conf['sm']['MsgSender'] = '46735877054';  // telefon s�nndare
$conf['sm']['MsgSenders'] =  array(46760942810, 46733402122, 46700476393, 46704597323); // telefon sändare
$conf['sm']['DestinationAddress'] = '46733668866';   // Till vilken mobilnummer? Använd bara under tester
...
$conf['ui']['logoImage'] = 'img/hemfresh_logo.gif';

// Welcome message show at login page ['Welcome to phpScheduleIt!']
$conf['ui']['welcome'] = 'V&auml;lkommen till HemFresh!';
...
*/
$conf['ui']['my_res'][]         = array ('color' => '6699FF', 'hover' => '66CCFF', 'text' => '000000');
$conf['ui']['other_res'][]      = array ('color' => '66CC99', 'hover' => 'AFBED3', 'text' => '000000');
$conf['ui']['my_past_res'][]    = array ('color' => 'D2D2D2', 'hover' => '6F7070', 'text' => 'FFFFFF');
$conf['ui']['other_past_res'][] = array ('color' => 'CCCCCC', 'hover' => 'ABABAB', 'text' => '000000');
...
// Available addresss to select when registering
// If you add values to this variable, they will appear in a pull down menu.  If you do not add values
//  then the address field will be a text box instead of a pull down menu
// Comment out (add // before all $conf['ui']['addresss'][]) to display a text box instead of a select menu
// Add $conf['ui']['addresss'][] values to add addresss
$conf['ui']['addresss'] = array();            // DO NOT CHANGE THIS LINE
//$conf['ui']['addresss'][] = "";

// Available citys to select when registering
// If you add values to this variable, they will appear in a pull down menu.  If you do not add values
//  then the city field will be a text box instead of a pull down menu
// Comment out (add // before all $conf['ui']['citys'][]) to display a text box instead of a select menu
// Add $conf['ui']['citys'][] values to add citys
$conf['ui']['citys'] = array();            // DO NOT CHANGE THIS LINE
//$conf['ui']['citys'][] = "";
...
$conf['app']['allowed_reminder_times'] = array(30, 720, 1200);

// See time block customization above
$conf['ui']['participant_res'][] = array ('color' => 'CE56D6', 'hover' => 'E174E8', 'text' => '000000');
